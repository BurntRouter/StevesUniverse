...
public class amethystwhip_entity extends EntityThrowable
{
	...
	public amethystwhip_entity(World world) {
		super(world);
	}

	public amethystwhip_entity(World world, EntityLivingBase entity) {
		super(world, entity);
	}

	public amethystwhip_entity(World world, double x, double y, double z) {
		super(world, x, y, z);
	}
